var size = 0;
var placement = 'point';
function categories_PlanningFrameworkLanduse_9(feature, value, size, resolution, labelText,
...
case 'Urban Deferred':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(128,62,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(255,188,87,0.5019607843137255)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_PlanningFrameworkLanduse_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("Land Use");
    ...
    var style = categories_PlanningFrameworkLanduse_9(feature, value, size, resolution, labelText,
