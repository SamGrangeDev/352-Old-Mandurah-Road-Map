...
map.getView().fit([12895580.034093, -3841792.981946, 12898066.623506, -3839555.964645], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">352 Old Mandurah Road Map</h2>';
        return titleElement;
    })(),
